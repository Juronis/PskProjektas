create table MEMBER (id int8 not null AUTO_INCREMENT, creditAmount int4 not null, password varchar(20), EMAIL varchar(150), ISFACEBOOKUSER boolean, isAdmin boolean not null, isFullMember boolean not null, USERNAME varchar(100) not null, primary key (id));
